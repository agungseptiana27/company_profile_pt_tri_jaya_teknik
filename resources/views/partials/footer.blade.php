    ...
    <div class="container mx-auto px-4 pt-10">
        <div class="grid md:grid-cols-3 gap-8 text-center md:text-left">
            ...
            <div class="text-left md:justify-self-end">
                ...
                <ul class="space-y-3">
                    <li><a href="" class="text-gray-700 hover:text-black transition duration-300">Sejarah</a></li>
                    <li><a href="profile-desa" class="text-gray-700 hover:text-black transition duration-300">Sertifikasi</a></li>
                    <li><a href="kabar-desa.index" class="text-gray-700 hover:text-black transition duration-300">Penghargaan</a></li>
                    <li><a href="galeri" class="text-gray-700 hover:text-black transition duration-300">Produka</a></li>
                    <li><a href="" class="text-gray-700 hover:text-black transition duration-300">Karir</a></li>
                    <li><a href="" class="text-gray-700 hover:text-black transition duration-300">Berita</a></li>
                </ul>
            </div>
            ...
            <div class="text-left md:justify-self-end">
                ...
                <ul class="space-y-3">
                    <li class="flex items-center">
                        <img src="{{ asset('images/icons/sms.svg') }}" 
                            alt="email" class="mr-2 w-5 h-5">
                        <span class="text-black">pt.tjtk@yahoo.com</span>
                    </li>
                    <li class="flex items-center">
                        <img src="{{ asset('images/icons/call.svg') }}" 
                            alt="phone" class="mr-2 w-5 h-5">
